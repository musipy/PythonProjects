...
def getRandomChests(numChests):
    ...
    while len(chests) < numChests:
        newChest = [random.randint(0, 39), random.randint(0, 9)]
...
while True:
    # Game setup
    sonarDevices = int(input('Enter the number of sonar devices you would like:'))
    theBoard = getNewBoard()
    theChests = getRandomChests(int(input('Enter the number of chests you wants:')))
    drawBoard(theBoard)
    previousMoves = []
